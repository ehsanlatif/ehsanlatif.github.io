/*!
    ...
    portfolio website.
*/
!function(n){n("html").removeClass("no-js"),n("header a").click(function(e){
    // Only use smooth scrolling for same-page links (those starting with #)
    if(!n(this).hasClass("no-scroll") && n(this).attr("href").charAt(0) === '#'){
        e.preventDefault();
